...
import { ArrowLeft, ExternalLink, Building, Users, FileText } from "lucide-react";
...
const InvestmentGroup = ({ user }: InvestmentGroupProps) => {
  ...
  const COLORS = ['#4338ca', '#7c3aed', '#06b6d4', '#10b981', '#f59e0b'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="bg-white shadow-sm">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Combined UPB of all properties
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white shadow-sm">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gray-900">
                {groupData.investorData.length}
              </div>
              <p className="text-xs text-gray-500 mt-1">
                Active investors in this group
              </p>
            </CardContent>
          </Card>
                  ...
                  <PieChart>
                    ...
                    >
                      {groupData.investorData.map((entry, index) => (
                        <Cell 
                          key={`cell-${index}`} 
                          fill={entry.isCurrentUser ? '#4338ca' : COLORS[index % COLORS.length]}
                          stroke={entry.isCurrentUser ? '#312e81' : 'none'}
          ...
          <Card className="bg-white shadow-sm">
            ...
            <CardContent className="flex flex-col justify-center h-64">
              <div className="text-center">
                ...
                <Button
                  onClick={() => window.open(groupData.partnershipAgreementLink, '_blank')}
